...
<body>
				...
				<div id="med_char_input">
					<div class="select-box shape">
						<i class="fa-solid fa-solid fa-shapes fa-2xl"></i> <input
							type="text" class="selected-data-input hidden" name="shape"
							value="" />
						<p>모양</p>
					</div>
					<div class="select-box color">
						<i class="fa-solid fa-droplet fa-2xl"></i> <input type="text"
							class="selected-data-input hidden" name="color" value="" />
						<p>색상</p>
					</div>
					...
					<div class="select-box line">
						<i class="fa-solid fa-light fa-tablets fa-2xl"></i> <input
							type="text" class="selected-data-input hidden" name="line"
							value="" />
						<p>분할선</p>
					</div>
				</div>
				...
				<div class="detail-view-box hidden">
					<div class="select-box-color">
						<img src="${path}/resources/img/main-png/색깔/no-background/1.png"
							data-value="전체" /> <input type="text" value="팔각형" class="hidden" />
						<h1>전체</h1>
					</div>
					<div class="select-box-color">
					...
					<div class="select-box-color">
						<img src="${path}/resources/img/main-png/색깔/no-background/12.png "
							data-value="남색" /> <input type="text" value="남색" class="hidden" />
						<h1>남색</h1>
					</div>
					<div class="select-box-color">
				...
				<div class="detail-view-box hidden">
					<div class="select-box-chart">
						<img src="${path}/resources/img/main-png/재질/no-background/1.png"
							data-value="전체" /> <input type="text" value="전체" class="hidden" />
						<h3>전체</h3>
					</div>
					<div class="select-box-chart">
				...
				<div class="detail-view-box hidden">
					...
					<div class="select-box-line">
						<img src="${path}/resources/img/main-png/선/no-background/2.png"
							data-value="없음" /> <input type="text" value="없음" class="hidden" />
						<h3>없음</h3>
					</div>
					<div class="select-box-line">
					...
					<div class="select-box-line">
						<img src="${path}/resources/img/main-png/선/no-background/5.png"
							data-value="기타" /> <input type="text" value="기타" class="hidden" />
						<h3>기타</h3>
					</div>
				</div>
			</div>
	...
	<form method="get" action="detailpage.html">
		<h1>
			shape:${shape}<br /> color:${color}<br /> chart:${chart}<br />
			line:${line}<br />
		</h1>
		<div id="result_box">
