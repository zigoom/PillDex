  ...
  <body>
    ...
    <form method="post" id="main-form" action="/ehr/apiload.do">
        ...
        <div style="display: flex; align-items: end">
          <div id="med_char_input">
            <div class="select-box shape">
              ...
              <input
                type="text"
                class="selected-data-input hidden"
                name="shape"
                value=""
              />
              <p>모양</p>
          ...
          <div class="detail-view-box hidden">
            ...
            <div class="select-box-shape">
              <img
                src="${path}/resources/img/eclipse.png"
                data-value="타원형"
              />
            ...
            <div class="select-box-shape">
              <img
                src="${path}/resources/img/rectangle.png"
                data-value="장방형"
              />
            ...
            <div class="select-box-shape">
              <img
                src="${path}/resources/img/semiCircle.png"
                data-value="반원형"
              />
              <input type="text" value="반원형" class="hidden" />
              <h3>반원형</h3>
            </div>
            <div class="select-box-shape">
              <img
                src="${path}/resources/img/triangle.png"
                data-value="삼각형"
              />
            ...
            <div class="select-box-shape">
              <img
                src="${path}/resources/img/rhombus.png"
                data-value="마름모"
              />
              <input type="text" value="마름모" class="hidden" />
              <h3>마름모</h3>
            </div>
            <div class="select-box-shape">
              <img
                src="${path}/resources/img/pentagon.png"
                data-value="오각형"
              />
            ...
            <div class="select-box-shape">
              <img
                src="${path}/resources/img/hexagon.png"
                data-value="육각형"
              />
            ...
            <div class="select-box-shape">
              <img
                src="${path}/resources/img/octagon.png"
                data-value="팔각형"
              />
          ...
          <div class="detail-view-box hidden">
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/1.png"
                data-value="전체"
              />
              <input type="text" value="팔각형" class="hidden" />
              <h1>전체</h1>
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/2.png "
                data-value="하양"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/3.png "
                data-value="노랑"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/4.png "
                data-value="주황"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/5.png "
                data-value="분홍"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/6.png "
                data-value="빨강"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/7.png "
                data-value="갈색"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/8.png "
                data-value="연두"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/9.png "
                data-value="초록"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/10.png "
                data-value="청록"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/11.png "
                data-value="파랑"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/12.png "
                data-value="남색"
              />
              <input type="text" value="남색" class="hidden" />
              <h1>남색</h1>
            </div>
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/13.png "
                data-value="자주"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/14.png "
                data-value="보라"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/15.png "
                data-value="회색"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/16.png "
                data-value="검정"
              />
            ...
            <div class="select-box-color">
              <img
                src="${path}/resources/img/main-png/색깔/no-background/17.png "
                data-value="투명"
              />
          ...
          <div class="detail-view-box hidden">
            <div class="select-box-chart">
              <img
                src="${path}/resources/img/main-png/재질/no-background/1.png"
                data-value="전체"
              />
            ...
            <div class="select-box-chart">
              <img
                src="${path}/resources/img/main-png/재질/no-background/2.png"
                data-value="정제"
              />
            ...
            <div class="select-box-chart">
              <img
                src="${path}/resources/img/main-png/재질/no-background/3.png"
                data-value="경질"
              />
            ...
            <div class="select-box-chart">
              <img
                src="${path}/resources/img/main-png/재질/no-background/4.png"
                data-value="연질"
              />
          ...
          <div class="detail-view-box hidden">
            <div class="select-box-line">
              <img
                src="${path}/resources/img/main-png/선/no-background/1.png"
                data-value="전체"
              />
              <input type="text" value="전체" class="hidden" />
              <h3>전체</h3>
            ...
            <div class="select-box-line">
              <img
                src="${path}/resources/img/main-png/선/no-background/2.png"
                data-value="없음"
              />
            ...
            <div class="select-box-line">
              <img
                src="${path}/resources/img/main-png/선/no-background/3.png"
                data-value="-"
              />
            ...
            <div class="select-box-line">
              <img
                src="${path}/resources/img/main-png/선/no-background/4.png"
                data-value="+"
              />
              <input type="text" value="+" class="hidden" />
              <h3>+형</h3>
      ...
      <form method="get" action="detailpage.html">
        <div id="result_box">
          <c:forEach var="pill" items="${searchData}">
  ...
  <script>
    ...
    document
      ...
      .addEventListener("click", function (e) {
        alert(selectedDataInput[0].value);
        alert(selectedDataInput[1].value);
        alert(selectedDataInput[2].value);
        alert(selectedDataInput[3].value);
      });
  </script>
</html>
