...
<html lang="ko">
    ...
    <body>
        ...
        <form id="serach_form" action="#" method="get">
            <div id="search_box_containor">
                <!--검색창-->
                <input name="search" id="search_area" type="text" placeholder="약 이름으로 검색" />
                <button id="search_button" class="btn btn-primary col-md-2 col-sm-3 col-4" type="submit">
                    검색 하기
                </button>
            </div>
        </form>
            ...
            <div id="shape_search_box">
                ...
                <div style="display: flex; align-items: end">
                    <div id="med_char_input">
                        ...
                        <input type="text" class="selected-data-input" name="printFB" value="" />
                        <p>식별자</p>
                    </div>
                    ...
                    <div class="detail-view-box hidden">
                        <div class="select-box-color">
                            <img src="${path}/resources/img/main-png/색깔/no-background/1.png" data-value="전체" />
                            <input type="text" value="팔각형" class="hidden" />
                            <h1>전체</h1>
                        </div>
                        <div class="select-box-color">
                        ...
                        <div class="select-box-color">
                            <img src="${path}/resources/img/main-png/색깔/no-background/12.png " data-value="남색" />
                    ...
                    <div class="detail-view-box hidden">
                        <div class="select-box-chart">
                            <img src="${path}/resources/img/main-png/재질/no-background/1.png" data-value="전체" />
                    ...
                    <div class="detail-view-box hidden">
                        <div class="select-box-line">
                            <img src="${path}/resources/img/main-png/선/no-background/1.png" data-value="전체" />
                            <input type="text" value="전체" class="hidden" />
                            <h3>전체</h3>
                        </div>
                        <div class="select-box-line">
                            <img src="${path}/resources/img/main-png/선/no-background/2.png" data-value="없음" />
    ...
    <script>
        ...
        selectedDataInput[7].addEventListener('blur', function () {
